...
class LiangshiSpider(scrapy.Spider):
    ...
    start_urls = [
        'http://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=fsnd&rowcode=zb&colcode=sj&wds=%5B%7B%22wdcode%22%3A%22reg%22%2C%22valuecode%22%3A%22{}%22%7D%5D&dfwds=%5B%7B%22wdcode%22%3A%22sj%22%2C%22valuecode%22%3A%22LAST5%22%7D%5D&k1={}'.
            format(valuecode, int(round(time.time() * 1000))) for valuecode in area]
    custom_settings = {
